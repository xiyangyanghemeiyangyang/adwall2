...
// 用户行为数据分析API
app.get('/api/user-behavior/analytics', (req, res) => {
  // 模拟数据分析接口
  const analyticsData = {
    overview: {
      totalUsers: 1250,
    ...
    popularJobs: [
      { jobTitle: '前端工程师', company: '腾讯', applications: 120, views: 500 },
      { jobTitle: '后端工程师', company: '阿里巴巴', applications: 95, views: 450 },
      { jobTitle: '数据分析师', company: '字节跳动', applications: 80, views: 380 },
      { jobTitle: '产品经理', company: '百度', applications: 75, views: 350 },
      { jobTitle: 'UI设计师', company: '京东', applications: 60, views: 280 },
      { jobTitle: '测试工程师', company: '美团', applications: 55, views: 250 }
    ],
    educationDistribution: [
      { education: '本科', count: 1200, percentage: 57.1 },
      { education: '硕士', count: 650, percentage: 31.0 },
      { education: '博士', count: 180, percentage: 8.6 },
      { education: '专科', count: 70, percentage: 3.3 }
    ],
    ageDistribution: [
      { ageRange: '22-25', count: 450, percentage: 21.4 },
      { ageRange: '26-30', count: 680, percentage: 32.4 },
      { ageRange: '31-35', count: 520, percentage: 24.8 },
      { ageRange: '36-40', count: 280, percentage: 13.3 },
      { ageRange: '41-45', count: 120, percentage: 5.7 },
      { ageRange: '46-50', count: 40, percentage: 1.9 },
      { ageRange: '51+', count: 10, percentage: 0.5 }
    ],
    skillDistribution: [
      { skill: 'JavaScript', count: 850, percentage: 40.5 },
      { skill: 'Python', count: 720, percentage: 34.3 },
      { skill: 'Java', count: 650, percentage: 31.0 },
      { skill: 'React', count: 580, percentage: 27.6 },
      { skill: 'Vue', count: 520, percentage: 24.8 },
      { skill: 'Node.js', count: 480, percentage: 22.9 },
      { skill: 'MySQL', count: 420, percentage: 20.0 },
      { skill: 'Redis', count: 380, percentage: 18.1 }
    ],
    regionDistribution: [
      { region: '华东', count: 650, percentage: 31.0 },
      { region: '华北', count: 580, percentage: 27.6 },
      { region: '华南', count: 420, percentage: 20.0 },
      { region: '华中', count: 280, percentage: 13.3 },
      { region: '西南', count: 120, percentage: 5.7 },
      { region: '西北', count: 40, percentage: 1.9 },
      { region: '东北', count: 10, percentage: 0.5 }
    ]
  };
